...
| NewTeamsAsDefault | This value provides notification to the user that your organization has installed the new version of Teams and it is ready for use. Users can choose Switch Now, or Switch when not using Teams. Users can switch back to Classic Teams if they want and they can opt in to New Teams also.|
